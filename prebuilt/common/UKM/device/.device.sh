...
#Unofficial
	...
	g2|galbi|ls980|vs980|d80?|g3|vs985|d85?|*m8*|honami|C6943|C690?|togari|C68??|shamu|d2*|jflte*|klte*|trlte*)
		CONFIG="hammerhead";; #g2|galbi|ls980|vs980|d80x = LG G2, g3|ls990|vs985|d85x = LG G3, *m8* = HTC One M8, honami|C6943|C690x = Sony Xperia Z1, 
			#togari|C68xx = Sony Xperia Z Ultra, shamu = Nexus 6, , d2* = Samsung Galaxy S3, jflte* = Samsung Galaxy S4, klte* = Samsung Galaxy S5, trlte* = Samsung Galaxy Note 4
	grouper|tilapia)
